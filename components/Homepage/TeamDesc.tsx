...
const TeamDesc = () => {
  return (
    <div className='w-full flex flex-col md:justify-end md:items-end py-16 '>
        <h2 className="text-3xl font-bold mb-5">
          Our unfair advantage
        </h2>
        <p className="text-[14px] md:text-[18px] tracking-wide md:text-end font-bold pb-7 text-white/80 ">
        ...
        <p className="text-[14px] md:text-[18px] tracking-wide md:text-end font-bold text-white/80 ">
