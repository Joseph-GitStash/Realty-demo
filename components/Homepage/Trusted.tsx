    ...
    <div className={cn(
      ...
      <div className="mb-8 text-center">
        <h2 className="text-2xl font-semibold mb-4">
          Companies the RealtyCorp team has invested in.
        </h2>
        <p className="text-[13px] md:text-[18px] shadow-2xl font-semibold text-white/80 tracking-wider ">
          Our platform supports these innovative companies.
        </p>
